...
export const CALL_QUESTION_ACTIONS = new Set([
  CALL_DIALOG_ACTIONS.ASK_BALANCE,
  CALL_DIALOG_ACTIONS.ASK_OPTIONS,
  CALL_DIALOG_ACTIONS.ASK_PLAN_SUMMARY,
  CALL_DIALOG_ACTIONS.ASK_LINK_DESTINATION,
  CALL_DIALOG_ACTIONS.ASK_LINK_CHANNEL,
  CALL_DIALOG_ACTIONS.CONFIRM_LINK_RECEIPT,
  CALL_DIALOG_ACTIONS.REPORT_LINK_NOT_RECEIVED,
]);
