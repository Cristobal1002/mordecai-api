    ...
    ArBalance.init(
      {
        ...
        pastDueTotalCents: { type: DataTypes.BIGINT, allowNull: true, field: 'past_due_total_cents' },
        pastDueRentCents: { type: DataTypes.BIGINT, allowNull: true, field: 'past_due_rent_cents' },
        unpaidRentCents: { type: DataTypes.BIGINT, allowNull: true, field: 'unpaid_rent_cents' },
